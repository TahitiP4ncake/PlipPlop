...
*\n
* \section setup SetUp
* Unpack Harmony plugin on your Unity game. You need an “AudioMixers” and an “AudioClips” folder for running it.
*
*\n
...
* v0.3 :
* Clean some aspect of the system.
* v0.2 :
 ...
 *  \copyright Baptiste Billet - 2017
*/
