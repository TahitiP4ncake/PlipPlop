...
////// Specular:
                ...
                float3 specularColor = _MainTex_var.b;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, _MainTex_var.b, specColor, specularMonochrome );
